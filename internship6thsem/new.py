...
class IPLStatsManager:
    ...
    def _initialize_empty_dataframe(self):
        ...
        self.stats = pd.DataFrame(
            columns=['player_id', 'player_name', 'team', 'match_date', 'runs', 'wickets', 'catches'])
...
# File Path (Use raw string format for Windows paths)
csv_file = r"E:\python\internship6thsem\ipl_data.csv"
