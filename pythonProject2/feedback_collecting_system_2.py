from feedback_collecting_system_1 import *
class FeedbackSystem(FeedbackCollectionSystem):
    ...
    def analyze_all_feedback_for_improvement(self):
        ...
        if total_feedback_count > 0:
            good_count = good_feedback_count
            better_count = better_feedback_count
            bad_count = bad_feedback_count
        ...
        return {
            "Good Feedback ": good_count,
            "Better Feedback ": better_count,
            "Bad Feedback ": bad_count
        }
    ...
    if login_option == 1:
        while True:
            ...
            if op == 1:
                ...
                if admin_username == 'priya' and pwd == feedback_system._admin_password:
                    while True:
